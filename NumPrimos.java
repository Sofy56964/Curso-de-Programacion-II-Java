...
public class NumPrimos{
	...
	public static void main(String[] args){
		...
		for(i=0; i<tam; i++){    //for que recorre el arreglo
			...
			array.add(aux);   //la funcion add Inserta el elemento especificado en la posición especificada en esta lista, es decir, rellena el arreglo vacio con numeros aleatorios en el intervalo especificado (1-200)
		...
		for(i=0; i<tam; i++){     //for que recorre el arreglo original(array) y toma los valores de los elementos en la posicion especificada y no se repite(no cambia de posicion) hasta que el for anidado (j) termine sus ejecuciones
                                                            //la funcion get(), Devuelve el elemento en la posición especificada en esta lista, entonces devolvera los valores de i, por ejemplo: array.get(0)=4, devolvera el 4					
			...
			if(cont==2){     //los numeros primos solo son divisibles entre si mismos y entre la unidad, por lo que si son divisibles entre mas numeros no es primo
				primos.add(array.get(i));     //add Inserta el elemento especificado en la posición especificada en esta lista, guarda los numeros primos dentro del arreglo    
			}
		}
		...
		for(i=0; i<tam; i++){    //for que recorre el arreglo original(array) y toma los valores de los elementos en la posicion especificada
			if(array.get(i)%2==0){    //si el modulo entre el elemento en la posicon i y dos es 0, entonces es un numero par
				pares.add(array.get(i));     //add Inserta el elemento especificado en la posición especificada en esta lista, guarda los numeros pares dentro del arreglo
			}
		}
