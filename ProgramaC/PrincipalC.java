...
public class PrincipalC{     //creacion de la clase
	...
	public static void main(String[] args){
		...
		int cont = 0;    //inicializa un contador en 0
		int no = 0;     //inicializa segundo contador en 0
		int acts = 0;   //inicializa tercer contador en 0
		float c;
		...
		do{
			...
			for(j=0; j<=x; j++){
				...
				c = leer.nextFloat();
				System.out.println("Digite si realizo actividades: ");
				a = leer.nextLine();
